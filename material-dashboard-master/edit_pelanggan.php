...
$response = $client->request('GET', '/api/Idpelanggan/', ['json' => [
    'id' => $id,
]]);
            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-5">
                                <h2>Update Data <b>Pelanggan</b></h2>
                            </div>
                            <div class="col-sm-7">
                                <a href="admin.php" class="btn btn-secondary"><span class="material-icons-outlined">Kembali</span></a>
                            </div>
                        </div>
                    </div>
                    <form action="edit_data_pelanggan.php?id=<?php echo $id?>" method="POST">
                    <div class="mb-3">
